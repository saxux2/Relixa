...
|----------|-----------|---------------------|-----------|------------------|-------------|
| Rupa Das | das@example.com | GDVGCNPYED7FFJ65MAGEP2V7B4HVLJ5HXQQNQE7KSXTDDBMX3LSP2EEB | [c99631d](https://github.com/saxux2/Relixa/commit/c99631d) | "I can't see the recent donations or transactions in real-time." | Added an animated scrolling transaction stream to show real-time platform activity |
| Puja Barai | puja@gmail.com | GBEUK7NAW6JIXCAOH7OUJMUKVCE44E4U2EC6LGX2JOEK6LOGZPWX23TO | [be624bb](https://github.com/saxux2/Relixa/commit/be624bb) | "The website layout is broken when I view it on my mobile browser." | Cleaned up mobile-forward responsiveness modules to fix layout on phone screens |
| Priya Pal | priya@gmail.com | GCVCHO43YMPEHBDWOVKP5Y2XZWEUHCZNPIGJRZAFFFGWMNGO5UVUMCO3 | [9dbb58e](https://github.com/saxux2/Relixa/commit/9dbb58e) | "When I cancel a transaction in my Freighter wallet, the app gets stuck." | Sanitized wallet session teardowns during interrupts to prevent freezing |
| Roni Dev | dev@investx.io | GCVDMNBJNKZFW5RVCARGIUAAAL364ODLPYDYM4UKGUJTS6NZG55H3M2J | [deb2569](https://github.com/saxux2/Relixa/commit/deb2569) | "Beneficiaries are having trouble transferring funds directly to local merchants." | Cemented local transfer logic between merchant and beneficiary accounts |
| Akash Biswas | akash@investx.io | GADWGNTRTYMFBBMVPFT6K46NTV3QCRNZZVHEX4IXWUFWA7GMUSAB7IM6 | [9154b50](https://github.com/saxux2/Relixa/commit/9154b50) | "The donation process feels unsafe and unclear. I need a proper secure form." | Engineered secure donor transmission forms for safer fund transfers |
