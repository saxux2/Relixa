...
|----------|-----------|---------------------|-----------|------------------|-------------|
| Rahul Sharma | rahul@example.com | GDAXP4Z75N7G4NVK2L3S4P5V7VYF7W5HNYXJ7AABT4J5DZXE7M | [ef2b2b5](https://github.com/saxux2/Relixa/commit/ef2b2b5) | "The Connect Wallet CTA heavily blends into the background scrolling." | Upgraded landing page UX with an expanded glowing CTA and an interactive dynamic navbar |
| Rupa Das | das@example.com | GDVGCNPYED7FFJ65MAGEP2V7B4HVLJ5HXQQNQE7KSXTDDBMX3LSP2EEB | [b0d21b4](https://github.com/saxux2/Relixa/commit/b0d21b4) | "I can't instantly tell if my wallet is actively connected to the platform." | Engineered an animated connection status indicator dot on the native wallet pill |
| Puja Barai | puja@gmail.com | GBEUK7NAW6JIXCAOH7OUJMUKVCE44E4U2EC6LGX2JOEK6LOGZPWX23TO | [75ffc34](https://github.com/saxux2/Relixa/commit/75ffc34) | "The platform features grid cards feel rigid and unresponsive." | Implemented responsive hover scale physics and Z-axis lift models for feature gallery cards |
| Priya Pal | priya@gmail.com | GCVCHO43YMPEHBDWOVKP5Y2XZWEUHCZNPIGJRZAFFFGWMNGO5UVUMCO3 | [c4a0a68](https://github.com/saxux2/Relixa/commit/c4a0a68) | "My transaction receipts confusingly mention Polygon Amoy instead of Stellar." | Sanitized digital transaction receipt engine to strictly utilize Stellar network infrastructure |
| Minakshi Lora | lora@gmail.com | GB7DTSTGE3O2X2VMANRX3PDNOB2DNJXHRVTX57QN45AJCQCVVJHUEA2X | [07d6b45](https://github.com/saxux2/Relixa/commit/07d6b45) | "As an organizer, I have to hard reload the tab to see updated campaign limits." | Embedded manual synchronous real-time data flow refresh controls inside the dashboard |
| Roni Dev | dev@investx.io | GCVDMNBJNKZFW5RVCARGIUAAAL364ODLPYDYM4UKGUJTS6NZG55H3M2J | [3e22721](https://github.com/saxux2/Relixa/commit/3e22721) | "If my merchant application gets rejected, it forces an unclear browser alert." | Designed an explicit persistent error boundary view for pending approval rejections |
| Akash Biswas | akash@investx.io | GADWGNTRTYMFBBMVPFT6K46NTV3QCRNZZVHEX4IXWUFWA7GMUSAB7IM6 | [17ac6f3](https://github.com/saxux2/Relixa/commit/17ac6f3) | "The quick-view floating success notifications link to a dead polygon scan." | Patched active toast notifications to accurately enforce Stellar Expert explorer routing |
| Tanvi Mishra | tanvi@gmail.com | GBB5NZHPP5I3ENL3MIT4WEARDNPSBI7GY4CUUVWWMZVC4ZWOXU22TZEE | [e591e3a](https://github.com/saxux2/Relixa/commit/e591e3a) | "There is no capability to extract merchant profile mapping externally." | Executed merchant index query parameter abstractions inside the core configuration file |
